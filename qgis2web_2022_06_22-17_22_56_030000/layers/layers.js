...
lyr_LapakGIScomBatas_Kecamatan_BIG_PPBW_0.set('fieldLabels', {'Kecamatan': 'inline label', 'Kabupaten': 'inline label', 'Provinsi': 'inline label', 'Kelurahan': 'no label', 'Dukuh': 'no label', 'P. PDAM': 'inline label', 'Jml Pndudk': 'inline label', });
